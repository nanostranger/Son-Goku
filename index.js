...
client.on('messageCreate', async message => {
    ...
    // FIX 3: Cleaner prompt formatting without exposing internal IDs
    ...
    try {
        ...
        // FIX 4: Pass the original rawPrompt to history for better context matching
        ...
        // FIX 5: Save the cleaned prompt instead of the formatted one for better search
