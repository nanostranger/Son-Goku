...
const GOKU_ACTIVITIES = [
 ...
 type: ActivityType.Playing },
    ...
    { name: 
 'Meditating on Namek', type: ActivityType.Listening },
...
client.on('guildCreate', async guild => {
    ...
    if (channel) {
        channel.send(`Hey there, buddies! I'm Son Goku, and I'm ready to hang out and maybe even have a little chat! I can talk, generate images, and I've got my eye on the latest 
 gossip. Just **@mention** me to start a conversation! Let's power up this server!`);
    }
});
...
switch (commandName) {
        ...
        case 'stop':
            ...
            await interaction.editReply(`Whew, 
 that was a good run! I'm gonna take a nap and won't respond until a moderator wakes me up. See ya later!`);
...
client.on('messageCreate', async message => {
    ...
    // FIX: Cleaner prompt formatting for Gemini
    const formattedPrompt = `[${guildName}] ${userName}: ${rawPrompt}`;
